...
# MongoDB Client
mongo_client = MongoClient('mongodb+srv://root:root@crawlertheguardian-sjvep.mongodb.net/crawlertheguardian?retryWrites=true&w=majority')
#Name of Database
name_of_database = mongo_client['crawlertheguardian']

#recovery of articles
def articles_of_database():
    # list of articles
    articles = []
    #get of articles the collection  articles
    col = name_of_database.get_collection("articles")
